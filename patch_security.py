...
with open('app/src/main/java/com/example/service/SecurityService.kt', 'r') as f:
    content = f.read()

replacement = """package com.example.service
...
content = re.sub(r'package com.example.service.*', replacement, content, flags=re.DOTALL)

with open('app/src/main/java/com/example/service/SecurityService.kt', 'w') as f:
    f.write(replacement)
